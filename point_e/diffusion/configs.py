...
BASE_DIFFUSION_CONFIG_3channel = BASE_DIFFUSION_CONFIG.copy()
BASE_DIFFUSION_CONFIG_3channel["channel_biases"] = BASE_DIFFUSION_CONFIG_3channel["channel_biases"][:3]
BASE_DIFFUSION_CONFIG_3channel["channel_scales"] = BASE_DIFFUSION_CONFIG_3channel["channel_scales"][:3]
DIFFUSION_CONFIGS = {
    "base40M-imagevec": BASE_DIFFUSION_CONFIG,
    "base40M-textvec": BASE_DIFFUSION_CONFIG,
    "base40M-textvec-3channel": BASE_DIFFUSION_CONFIG_3channel,
