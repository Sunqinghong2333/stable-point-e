...
# Model arguments
parser.add_argument('--latent_dim', type=int, default=768) #ViT-L/14
...
def train(it):
    ...
    # import ipdb
    # ipdb.set_trace()
    # net = model_clip.clip_model
    # for name,parameters in net.named_parameters(): 
    #     if name in ["text_projection", "positional_embedding", "token_embedding.weight", "transformer.resblocks.11.ln_2.weight"]:
    #         print(name,':',parameters)


    logger.info('[Train] Iter %04d | Loss %.6f | Grad %.4f | Lr %.6f' % (it, loss.item(), orig_grad_norm, optimizer.param_groups[0]['lr']))
